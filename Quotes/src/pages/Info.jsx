...
const Info = () => {
    ...
    return(
        <div className="info">
            ...
            <p>Delete a post must also be done at your home page. <br/>If you have any post, they should appear under the publish box. Each of your posts should have a button that says "X". Simply click that button on the post you want to delete and you will be asked to confirm. Look at the image below for more help.</p>
